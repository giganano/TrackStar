...
def write_version_info(filename = "./trackstar/version_breakdown.dat"):
	r"""
	...
	version = trackstar.version(**VERSION)
	with open(filename, 'w') as out:
		out.write("# This file was generated by trackstar setup.py ")
		out.write("version %s\n" % (str(version)))
...
def setup_package():
	...
	metadata = dict(
		name = package_name,
		version = str(trackstar.version(**VERSION)),
